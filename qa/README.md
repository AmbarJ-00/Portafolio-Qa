...
2. **Accesibilidad (WCAG 2.1):** Verificar la navegación por teclado (tab index), etiquetas ARIA, y contrastes mínimos de color.
...
El script valida tanto la consistencia de traducciones como la integridad de los de configuración pública y administrativa.

## Información del admin
* **Ruta del admin:** `http://localhost:3000/backoffice/login` (o en producción `/backoffice/login`)
