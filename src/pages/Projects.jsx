          ...
          {store.projects.map((project) => {
            ...
            return (
              <motion.div
                ...
                className="glass-card glass-card-hover rounded-2xl flex flex-col justify-between overflow-hidden relative group"
              >
                ...
                <div className="p-6 space-y-6 flex-grow">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {project.integrations.slice(0, 3).map((tag, idx) => (
                      <span 
                        key={idx} 
                  ...
                  {/* Metrics preview */}
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-brand-ash-200/50 dark:border-brand-navy-800/30">
