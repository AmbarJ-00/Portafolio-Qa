      ...
      <section className="rounded-[1.75rem] border border-[#17364F] bg-[#0D1A2F]/80 p-6 shadow-sm text-[#E2E8F0]">
        <form onSubmit={handleSubmit(onSubmit)} className="grid gap-5 lg:grid-cols-2">
          ...
          <div className="lg:col-span-2 flex justify-end">
            <button type="submit" className="rounded-2xl bg-[#09D8C7] px-6 py-3 text-sm font-semibold text-[#0D1A2F] hover:bg-[#08c1b6] transition shadow-lg shadow-[#09D8C7]/10">
              Guardar contacto
            </button>
          </div>
        </form>
        ...
        >
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-3xl border border-[#17364F] bg-[#0D1A2F]/80 p-4">
              ...
              <p className="mt-2 text-sm text-[#C9F7EE]">Usa una dirección oficial.</p>
            </div>
          </div>
        </Modal>
      )}
